...
export default {
    ...
    [SET_LIST_SUIVI](state, lists) {
        state.lists = lists
        localStorage.setItem('suvi-indicateurs-mod', JSON.stringify(lists))
    },
    ...
    [MODIFY_SUIVI](state, suivi) {
        ...
        localStorage.setItem('suvi-indicateurs-mod', JSON.stringify(state.lists))
    },
    ...
    [REMOVE_SUIVI](state, IdSuivi) {
        ...
        state.lists = [...suivis]
        localStorage.setItem('suivi-indicateurs-mod', JSON.stringify(state.lists))
    },
};
