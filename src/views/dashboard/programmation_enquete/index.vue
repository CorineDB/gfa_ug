        ...
        columns: [
            ...
            },
            {
                ...
                formatter: (cell) => {
                    ...
                    const voirApprecationsButton = createButton("Voir Apprecations", "btn btn-primary", () => {
                    ...
                    container.append(voirApprecationsButton, modifyButton, deleteButton);
        ...
        <div class="flex flex-wrap items-center justify-between col-span-12 mt-2 intro-y sm:flex-nowrap">
            ...
            <div class="flex">
                <button class="mr-2 shadow-md btn btn-primary" @click="openCreateModal">
                    <PlusIcon class="w-4 h-4 mr-3" />Ajouter un Enquête de Gouvernace
                </button>
            </div>
        </div>
    </div>
