    ...
    <Modal :show="deleteModalPreview" @hidden="deleteModalPreview = false">
      <ModalBody class="p-0">
        ...
        <div class="px-5 pb-8 text-center">
          ...
          <button type="button" @click="deleteRole" class="btn btn-danger w-24">Supprimer</button>
        </div>
      </ModalBody>
    </Modal>
    <!-- END: Modal Content -->
      ...
      <ModalBody class="p-10">
        <form v-if="!isUpdate" key="ajouter" @submit.prevent="storeRole">
          ...
          <div class="my-2">
            ...
            <input id="regular-form-1" type="text" required v-model="formData.description" class="form-control" placeholder="Description du role" />
        ...
        <form v-else key="modifier" @submit.prevent="updateRole">
          ...
          <div class="my-2">
            <label for="regular-form-1" class="form-label">Description</label>
            <input id="regular-form-1" type="text" required v-model="saveUpdate.description" class="form-control" placeholder="Description du role" />
            <p class="text-red-500 text-[12px] mt-2 col-span-12" v-if="messageErreur.description">{{ messageErreur.description }}</p>
          </div>
          <div class="my-2">
            <label for="regular-form-1" class="form-label">Permissions </label>
