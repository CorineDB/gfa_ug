  ...
  <dashboard>
    <div class="w-full">
          ...
          <div>
            <ol class="inline-flex p-0 list-none">
              ...
              <li class="flex items-center ">
                <router-link to="" class="text-gray-600">Suivi componente </router-link>
              </li>
            </ol>
          </div>
          <div>
        ...
        <div class="flex items-center justify-between my-4">
          <titre>Le suivi composante  </titre>
        ...
        <div class="flex mt-12 space-x-4 ">
          <div class=" w-1/3 bg-white shadow p-2">
            <div class="w-full">
              <div>
                <p class=" text-sm   py-2"><span class="font-bold uppercase px-1">Composante</span> : {{composante.nom}} </p>
                <p class=" text-sm   py-2"><span class="font-bold uppercase px-1">Description</span> : {{composante.description}} </p>
                <p class=" text-sm   py-2"><span class="font-bold uppercase px-1">Bailleur</span> : {{composante.sigle}} </p>
                <p class=" text-sm   py-2"><span class="font-bold uppercase px-1">Code PTA</span> : {{composante.codePta}} </p>
                <p class=" text-sm   py-2"><span class="font-bold uppercase px-1">Poids initial</span>:{{composante.poids}} </p>
