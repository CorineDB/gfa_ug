<template>
 ...
 mb-2" >
    ...
    <div class="">
        <sous-composante-current :valeurProjet="{codePta:$route.params.codeP,nom:$route.params.nomP}" :valueProfondeur="{codePta:$route.params.code,nom:$route.params.nom}" v-if="currentPage"></sous-composante-current>
